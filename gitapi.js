...
let gitAPI = function() { // this is the closure function
  ...
  this.getRepos = (main_language, supporting_languages) => {
    ...
    LANGUAGE_POOL = self.changeToLowerCase(LANGUAGE_POOL);
    ...
    return new Promise((resolve, reject) => {
      ...
      request.get(git_search_api, options, (error, response, body) => {
        ...
        _.forEach(filteredData, (repo) => {
          ...
          self.getUserRepos(user_repo_endpoint).then((res) => {
            // console.log("user_repo_endpoint");
            ...
            var userDetails = new userData({
              ...
              language_counts: language_matches,
              rank: 0
            });
...
var self = module.exports=exports=new gitAPI();
